      ...
      <div className="border-4 rounded-xl overflow-hidden bg-white">
        <div className="p-12 text-center">
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            Hemos realizado una pre-autorización en tu tarjeta, una vez que
            inspecciones tu vehículo, el cobro se completará y la cobertura
            quedará activa.
          </p>
          ...
          <p className="text-orange-500 font-medium text-base mb-8">
            Tienes 72 horas para inspeccionar, de lo contrario la cotización se
            cancelará.
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-2 max-w-2xl mx-auto">
            Te hemos enviado un email y SMS con un link para que realices la
            inspección en linea desde tu celular.
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            ¿No lo recibiste?{" "}
          ...
          {finishResendingEmail && (
            <Alert variant={emailWasSent ? 'default' : 'destructive'} className="mb-6 relative">
              <AlertCircleIcon />
              <AlertTitle>
