        ...
        <>
            <div className='flex flex-col items-center gap-6 mb-4'>
                ...
                <div className='text-green-600 flex justify-center items-center gap-2'>
                    ...
                    <p className='text-sm'>
                        Con tu compra ayudarás a sembrar 2 arboles en los
                        bosques de la amazonia.
                    </p>
                </div>
                <div className='flex flex-col items-center'>
                    <p className='text-sm'>
                        Aquí te mostramos lo que estas contratando,
                    </p>
                    <p className='text-sm'>
            ...
            <div className='bg-white rounded-lg border border-gray-200 shadow'>
                <Accordion
                            ...
                            <div className='space-y-6'>
                                <div className='grid gap-4 md:grid-cols-2'>
                                    <div className='space-y-1'>
                                        ...
                                        <p className='text-base font-semibold text-foreground'>
                                            {insuranceData.customer.firstName}{' '}
                                            {insuranceData.customer.lastName}
                                        </p>
                                    </div>
                                    <div className='space-y-1'>
                                        <p className='text-sm font-medium text-muted-foreground'>
                    ...
                    <AccordionItem value='item-5' className='border-b-0'>
                        ...
                        <AccordionContent className='px-6 pb-6 pt-2'>
                            <p>Las Exclusiones y consideraciones</p>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
